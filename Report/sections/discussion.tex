...
Using subdivision trees as a representation seems to be a successful approach. The results of the parser with a simple 
...
\caption{An example of why rests are needed to correctly represent the last note.}
\label{fig:rests}
\end{figure}
